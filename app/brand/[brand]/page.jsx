...
export default function BrandDetailPage({ params }) {
  ...
  // Load all fragrances for this brand, ordered by name (asc)
  useEffect(() => {
    (async () => {
      setLoading(true);
      const { data, error } = await supabase
        ...
        .ilike('brand', brandParam) // case-insensitive match
  ...
  // Safety net: client-side sort in case DB ordering is ever bypassed
  ...
  return (
    <div className="mx-auto max-w-6xl w-full px-2">
      {/* Boutique-style header to match the rest of the site */}
